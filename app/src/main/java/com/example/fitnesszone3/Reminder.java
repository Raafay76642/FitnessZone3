...
public class Reminder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appDatabase = AppDatabase.geAppdatabase(Reminder.this);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(Reminder.this);
    ...
    public void addReminder(){
        ...
        select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(Reminder.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, final int year, final int month, final int dayOfMonth) {

                        final Calendar newDate = Calendar.getInstance();
                        Calendar newTime = Calendar.getInstance();
                        TimePickerDialog time = new TimePickerDialog(Reminder.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                if(newDate.getTimeInMillis()-tem.getTimeInMillis()>0)
                                    ...
                                    Toast.makeText(Reminder.this,"Invalid time",Toast.LENGTH_SHORT).show();
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Reminder.this,NotifierAlarm.class);
                ...
                PendingIntent intent1 = PendingIntent.getBroadcast(Reminder.this,reminders.getId(),intent,PendingIntent.FLAG_UPDATE_CURRENT);
                AlarmManager alarmManager = (AlarmManager)getSystemService(ALARM_SERVICE);
                alarmManager.setExact(AlarmManager.RTC_WAKEUP,calendar.getTimeInMillis(),intent1);

                Toast.makeText(Reminder.this,"Inserted Successfully",Toast.LENGTH_SHORT).show();
                setItemsInRecyclerView();
