...
public class VerifyCode extends AppCompatActivity {
    ...
    private void sendVerificationCode(String mobile) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                this,
                mCallbacks);
        PhoneAuthProvider.getInstance().verifyPhoneNumber("+92"+mobile,60,TimeUnit.SECONDS, TaskExecutors.MAIN_THREAD,mCallbacks);
    }
                ...
                .addOnCompleteListener(VerifyCode.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //for opening activity after login
                            Intent intent = new Intent(VerifyCode.this, BmiCalculator.class);
